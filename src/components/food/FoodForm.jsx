...
//   return (
//     <Container maxWidth="md" sx={{ padding: { xs: 2, sm: 4 }, backgroundColor: "#f9f9f9", borderRadius: 2, boxShadow: 3 }}>
//       <Typography variant="h4" gutterBottom sx={{ fontWeight: "bold", color: "#4caf50", textAlign: "center", fontSize: { xs: '1.5rem', sm: '2rem' } }}>
...
//                         {values.meals[mealType].map((foodItem, index) => (
//                           <Grid item xs={12} key={index}>
//                             <Box sx={{ p: 2, border: '1px solid #e0e0e0', borderRadius: 2, position: 'relative' }}>
//                               <Grid container spacing={2}>
//                                 <Grid item xs={12} sm={6}>
//                                   <FormControl fullWidth>
//                                     <InputLabel>Food Item</InputLabel>
...
//                   fullWidth={isMobile}
//                 >
//                   {loading ? "Tracking..." : "Track Nutrition"}
//                 </Button>
//               </Tooltip>
//             </Grid>
//           </Form>
